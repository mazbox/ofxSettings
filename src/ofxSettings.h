...
public:
	...
	void set(string key, const ofVec3f &value);
	void set(string key, const ofRectangle &r);
	...
	/** get a coordinate */
	ofVec3f getVec3(string key, ofVec3f defaultValue = ofVec3f());
	
	/** get a rectangle */
	ofRectangle getRect(string key, ofRectangle defaultValue = ofRectangle(0, 0, 1, 1));
